...
- **Timeouts/Intervals**: Limits are strictly enforced via `safeNumber()`. Configured values are proactively validated and clamped to safe boundaries at server startup.

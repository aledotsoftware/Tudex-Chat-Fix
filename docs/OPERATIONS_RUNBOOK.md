...
- `API_KEY`: Must be at least 8 characters long in production environments to avoid security warnings. Setting the `API_KEY` to an empty string will explicitly disable API authentication, triggering a severe security warning in the logs.
